...
public class TransmissionSession {
     ...
     * "alt-speed-time-begin"           | number     | when to turn on alt speeds (units: minutes
     * after midnight)
     * "alt-speed-time-enabled"         | boolean    | true means the scheduled on/off times are
     * used
     * "alt-speed-time-end"             | number     | when to turn off alt speeds (units: same)
     * "alt-speed-time-day"             | number     | what day(s) to turn on alt speeds (look at
     * tr_sched_day)
     * "alt-speed-up"                   | number     | max global upload speed (KBps)
     * "blocklist-url"                  | string     | location of the blocklist to use for
     * "blocklist-update"
     * "blocklist-enabled"              | boolean    | true means enabled
     * "blocklist-size"                 | number     | number of rules in the blocklist
     * "cache-size-mb"                  | number     | maximum size of the disk cache (MB)
     * "config-dir"                     | string     | location of transmission's configuration
     * directory
     * "download-dir"                   | string     | default path to download torrents
     * "dht-enabled"                    | boolean    | true means allow dht in public torrents
     * "encryption"                     | string     | "required", "preferred", "tolerated"
     * "idle-seeding-limit"             | number     | the default seed inactivity limit for
     * torrents to use
     * "idle-seeding-limit-enabled"     | boolean    | true if the seeding inactivity limit is
     * honored by default
     * "incomplete-dir"                 | string     | path for incomplete torrents, when enabled
     * "incomplete-dir-enabled"         | boolean    | true means keep torrents in incomplete-dir
     * until done
     * "lpd-enabled"                    | boolean    | true means allow Local Peer Discovery in
     * public torrents
     ...
     * "rename-partial-files"           | boolean    | true means append ".part" to incomplete
     * files
     ...
     * "start-added-torrents"           | boolean    | true means added torrents will be started
     * right away
     * "trash-original-torrent-files"   | boolean    | true means the .torrent file of added
     * torrents will be deleted
